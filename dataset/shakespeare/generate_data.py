...
def save_task(dir_path, train_text, test_text, val_text=None):
    ...
    with open(os.path.join(dir_path, "train", "train.txt"), 'w') as f:
        f.write(train_text)

    with open(os.path.join(dir_path, "test", "test.txt"), 'w') as f:
        f.write(test_text)

    if val_text is not None:
        with open(os.path.join(dir_path, "val", "val.txt"), 'w') as f:
            f.write(val_text)
...
def main():
    ...
    train_text, test_text = train_test_split(total_text, args.tr_frac)
